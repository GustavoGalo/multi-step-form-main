    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="#6259FF"
          fillRule="evenodd"
          d="M-34.692 543.101C3.247 632.538 168.767 685.017 211.96 612.52c43.194-72.497-66.099-85.653-104.735-160.569C68.59 377.035 38.568 330.277-17.257 347.344c-55.824 17.068-55.375 106.32-17.436 195.757z"
          clipRule="evenodd"
        />
        <path
          fill="#F9818E"
        ...
        <path
          ...
          strokeWidth={5}
          d="M165.305 469.097l10.607-10.806m33.549 16.29l-12.506-10.503m-9.395 24.913l-6.908 14.798"
        />
        <path
          fill="#FFAF7E"
